<fieldset class="formulario__fildset">
    <legend class="formulario__legend">Información del Ponente</legend>
...
<fieldset class="formulario__fildset">
    ...
    <div class="formulario__campo">
        <label for="tags_input" class="formulario__label">Areas de Experiencia (separadas por comas)</label>
            <input 
                type="text"
                class="formulario__input"
                id="tags_input"
                placeholder="Ej. Node.js, React, CSS, HTML"
                >
