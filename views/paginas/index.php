...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion() ?> class="resumen__bloque">
            <p class="resumen__texto resumen_texto--numero"><?php echo $ponentes_total; ?></p>
            <p class="resumen__texto">Speakers</p>
        </div>

        <div <?php aos_animacion() ?> class="resumen__bloque">
            <p class="resumen__texto resumen_texto--numero"><?php echo $conferencias_total; ?></p>
            <p class="resumen__texto">Conferencias</p>
        </div>

        <div <?php aos_animacion() ?> class="resumen__bloque">
            <p class="resumen__texto resumen_texto--numero"><?php echo $workshops_total; ?></p>
            <p class="resumen__texto">Workshops</p>
        </div>

        <div <?php aos_animacion() ?> class="resumen__bloque">
            <p class="resumen__texto resumen_texto--numero">500</p>
    ...
    <?php foreach($ponentes as $ponente) { ?>
        <div <?php aos_animacion() ?> class="speaker">
            <picture>
                ...
                <img class="speaker__imagen" src="img/ponentes/<?php echo $ponente->imagen; ?>.png" alt="Imagen Ponente" loading="lazy" width="200" height="300">
            </picture>
