<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <h3 class="footer__logo">DevWebCamp &copy; <?php echo date('Y'); ?> </h3>

            <p class="footer__texto">DevWevCamp es una conferencia de desarolladores para todo los niveles y se lleva a cabo de forma presencial y en linea</p>
        </div>
