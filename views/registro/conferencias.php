    ...
    <p class="pagina__descripcion">Elige 5 Eventos para ir de forma presencial</p>
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">Conferencias</h3>
        <p class="eventos-registro__fecha">Viernes 5 de Noviembre del 2024</p>
        ...
        <p class="eventos-registro__fecha">Sábado 6 de Noviembre del 2024</p>
    ...
    <aside class="registro">
        ...
        <form id="registro" class="formulario">
            <div class="formulario__campo">
                <input type="submit" class="formulario__submit formulario__submit--full" value="Registrame">
            </div>
        </form>
    </aside>
</div>    
